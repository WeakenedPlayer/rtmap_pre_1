...
export class ProfileSet {
    constructor( profile: Census.CharacterProfile,
                 world: Census.World,
}

// 一式持ってくる。ステータスも表示できるようにする
export class ProfileLoader {
    ...
    constructor( private census: Census.Service ) {
        ...
        this.zippedObservable = Observable.zip( this.cidSubject, this.profileObservable, this.worldObservable, this.onlineStatusObservable )
        .do( () => {
